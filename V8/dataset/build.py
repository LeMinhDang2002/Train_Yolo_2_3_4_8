...
try:
    ...
    from .platenumber import PlateNumberDataset
...
def build_dataset(args, data_cfg, trans_config, transform, is_train=False):
    ...
    ## Plate Number dataset
    elif args.dataset == 'plate_number':
        image_set = 'train' if is_train else 'val'
        dataset = PlateNumberDataset(data_dir     = data_dir,
                                    img_size     = args.img_size,
                                    image_set    = image_set,
                                    transform    = transform,
                                    trans_config = trans_config,
    ...
    ## Character Number dataset
    elif args.dataset == 'character':
        image_set = 'train' if is_train else 'val'
        dataset = CharacterDataset(data_dir     = data_dir,
                                    img_size     = args.img_size,
                                    image_set    = image_set,
                                    transform    = transform,
                                    trans_config = trans_config,
